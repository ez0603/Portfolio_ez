...
`;const mn=function(e){let{children:t}=e;return pn("div",{css:gn,children:[fn(hn,{}),t]})},An=Lt`
  z-index: 0;
  width: 100%;
  height: 100%;
  background-color: #141414;
...
`,Uo=Lt`
  ...
  z-index: 0;
  position: relative;
`;const zo=function(e){let{description:n,image:r,onClose:o}=e;const[i,a]=(0,t.useState)(!1);(0,t.useEffect)((()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="auto"})),[]);const l=()=>{a(!0),setTimeout((()=>{o()}),300)};return(0,Yt.createPortal)(fn("div",{css:Ro,onClick:e=>{e.target===e.currentTarget&&l()},children:pn("div",{css:No(i),children:[fn("button",{onClick:l,css:Lo,children:fn("span",{css:Po,children:fn(Er,{})})}),pn("div",{css:Qo,children:[pn("div",{css:Mo,children:[fn("img",{src:r,alt:"",css:Uo}),fn("div",{css:Oo})]}),fn("p",{children:n})]})]})}),document.body)},Fo=Lt`
  width: 100%;
...
`,gi=n.p+"static/media/rotated_\ubc14\ub2e4\uc0ac\uc9c4.26fc36b03d47ebba88fc.jpg",mi=n.p+"static/media/\uc774\uc9c0\uc5b82.080e66a9d04618054453.jpg";const Ai=function(e){const n=(0,t.useRef)(null),r=(0,t.useRef)(null),[o,i]=(0,t.useState)(null),a=Dr(),[l,s]=(0,t.useState)(!1),[u,c]=(0,t.useState)({description:"",image:""}),d=()=>{const e=n.current;r.current=setInterval((()=>{e.scrollLeft+=1,e.scrollLeft>=e.scrollWidth-e.clientWidth&&(e.scrollLeft=0)}),15)},f=()=>{clearInterval(r.current)};(0,t.useEffect)((()=>(l?f():d(),()=>{f()})),[l]);const p=()=>{d(),i(null)},h=e=>{e.preventDefault()},g=[Ur,[Nr,Lr],Mr,Pr,Rr,Or,Qr,zr],m=[...g,...g];return fn(mn,{children:fn("div",{css:ti,children:pn("div",{css:ni,children:[pn("div",{css:ri,onContextMenu:h,children:[fn("div",{css:(A=gi,Lt`
  width: 100%;
  height: 100%;
